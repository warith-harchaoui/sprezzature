...
| **sprezzature-figures** | Vous produisez des figures pour la science des données (124 types de graphiques en image vectorielle SVG écrite à la main, graphiques d'explicabilité compris (explications additives de Shapley / SHAP, Shapash / TimeSHAP, explications locales interprétables / LIME)), des estimations d'effet causal (DoWhy / EconML), des diagrammes TikZ / Mermaid, des cartes thématiques ou des cartes de zones de contrôle (« situation ») pour n'importe quelle région, affinés par la **Ralph Eyeball Loop** (rendre → regarder → corriger la source), avec un auditeur pre-commit pour les fautes de visualisation de données et des niveaux d'accessibilité à la vision des couleurs sur chaque figure. | « make a figure », « hand-authored SVG », « render this diagram », « mermaid diagram », « ralph eyeball loop », « no ascii art », « SHAP plot », « choropleth », « world map », « situation map », « areas of control », « DoWhy », « DAG », « audit this figure ». |
