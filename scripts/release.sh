...
EXCLUDES=(
    ...
    --exclude='.mypy_cache'
    --exclude='.ruff_cache'
    # Rendered showcase figures (the website gallery) are regenerated by the
    # generators; they belong on the site, not in the shipped skill. Keep this
    # list in step with SHOWCASE_DIRS in scripts/package_skill.py, which
    # enforces the same rule for the Claude skill-import zips.
    --exclude='figures-gallery'
    --exclude='svg-examples'
    --exclude='situation-maps'
)
